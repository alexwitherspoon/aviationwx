...
│   ├── webcam-error-detector.php # Webcam image validation (error frames, uniform color, truncated JPEG fill)
...
5. ProcessingPipeline.process()
   ...
   - Error frame detection (uniform color, truncated JPEG mid-grey fill, Blue Iris errors)
