<?php
/**
 * SWOB-ML MAN Adapter v1
 *
 * Fetches weather from Environment Canada SWOB-ML for manned Canadian
 * stations (NAV Canada HWOS). Uses {ICAO}-MAN-swob.xml endpoint.
 *
 * Configuration:
 * - station_id: ICAO station identifier (e.g., "CYVR", "CYYZ") - REQUIRED
 *
...
class SwobManAdapter
{
    ...
    public const SOURCE_TYPE = 'swob_man';
    ...
    /**
     * Build the fetch URL for a SWOB MAN station
     *
     * @param array $config Source config with station_id (e.g., "CYVR")
    ...
    public static function buildUrl(array $config): ?string
    {
        ...
        return self::BASE_URL . '/' . $stationId . '-MAN-swob.xml';
    }
