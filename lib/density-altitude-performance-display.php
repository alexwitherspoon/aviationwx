...
function densityAltitudePerformanceOperationalEndLabel(?array $performance): string
{
    ...
    $rwyId = isset($performance['operational_rwy_id'])
        ? trim((string) $performance['operational_rwy_id'])
        : '';
