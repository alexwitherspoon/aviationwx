...
{
    if ($scope === 'airspace') {
        return notamClassifyAirspaceTfrCategory((string) ($notam['text'] ?? ''));
    }
...
/**
 * @deprecated Use {@see notamClassifyAirspaceTfrCategory()}.
 */
function notamBannerClassifyAirspaceCategory(string $text): string
{
    return notamClassifyAirspaceTfrCategory($text);
}
 ...
 * @param string $text NOTAM body
 * @deprecated Use {@see notamBuildAirspaceTfrHeadline()}.
 */
function notamBannerBuildAirspaceHeadline(string $category, string $text): string
{
    return notamBuildAirspaceTfrHeadline($category, $text);
}
