        ...
        <section id="add-to-home-screen" class="airports-pwa-section" aria-labelledby="add-to-home-screen-heading">
            <div class="airports-pwa-inner">
                ...
                <p class="airports-pwa-lead">
                    To quickly access AviationWX, here's how to add an icon shortcut to your Home Screen similar to an app. This is optional, as the site works fully in the browser. AviationWX is <strong>not</strong> in the Google Play or Apple App stores and is free to use.
                </p>
                    ...
                    <div class="airports-pwa-card">
                        ...
                        <figure class="airports-pwa-figure">
                            <picture>
                                ...
                                <?php endif; ?>
                                <!-- width/height match pwa-add-to-home-screen-android.jpg; update if screenshot pixels change -->
                    ...
                    <div class="airports-pwa-card">
                        ...
                        <figure class="airports-pwa-figure">
                            <picture>
                                ...
                                <?php endif; ?>
                                <!-- width/height match pwa-add-to-home-screen-ios.jpg; update if screenshot pixels change -->
