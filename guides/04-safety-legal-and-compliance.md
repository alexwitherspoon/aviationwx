...
1. **Get permission** from the airport owner/sponsor (or their designated stewardship group).  
...
- Using an existing, approved mounting point
...
Do:
- Treat it like a “construction safety” activity: have an escort if required, create a simple safety plan, coordinate times, use markings/barricades when appropriate.
- Reference AC 150/5370-2G (Construction Safety and Phasing Plan guidance)
...
Links:
- ARP SOP 2.00 (FAA ALP review/approval procedures): https://www.faa.gov/sites/faa.gov/files/airports/resources/sops/arp-SOP-200-ALP-Review.pdf
- FAA “ALP approval preliminary instructions” (Reauthorization-era guidance): https://www.faa.gov/airports/planning_capacity/alp-approval-preliminary-instructions

> Practical takeaway: **Don’t try to “self-decide” ALP impacts.** Ask the airport sponsor/manager what their normal process is and who their FAA contact is.
...
Links:
- AC 150/5300-13B page: https://www.faa.gov/airports/resources/advisory_circulars/index.cfm/go/document.current/documentnumber/150_5300-13
- AC 150/5300-13B (PDF): https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC-150-5300-13B-Airport-Design-Chg1-w-errata.pdf

**Plain language summary:**  
- Airports have **keep-clear areas** near runways and taxiways so that aircraft can operate safely even if they veer off the pavement or need room for wings/props/jet blast.  
- Your installation should not add objects in those areas. If you’re unsure, the airport sponsor/manager can tell you where their RSAs/ROFAs and other critical areas are.

> AviationWX guidance: we’d rather choose a slightly “less perfect” mount than place equipment where it creates hazard exposure.
...
Links:
- AC 70/7460-1M page: https://www.faa.gov/regulations_policies/advisory_circulars/index.cfm/go/document.current/documentnumber/70_7460-1
- AC 70/7460-1M (PDF): https://www.faa.gov/documentLibrary/media/Advisory_Circular/Advisory_Circular_70_7460_1M.pdf
- AC 70/7460-1M Change 1 (PDF): https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC_70-7460-1M_Change_1.pdf

**Plain language summary:**  
- If a structure could be hard to see (especially at night) and is near flight paths, marking/lighting may be required.  
- AviationWX installs usually aim to be **low-profile**, but any new pole/tower needs a safety review mindset.
...
Links:
- AC 150/5370-2G page: https://www.faa.gov/airports/resources/advisory_circulars/index.cfm/go/document.current/documentnumber/150_5370-2
- AC 150/5370-2G (PDF): https://www.faa.gov/documentLibrary/media/Advisory_Circular/150-5370-2G.pdf
...
## (Optional) Part 139 airports (certificated airports)
Most small GA airports are **not** Part 139, but some airports you encounter may be.

**What it is:** Part 139 governs FAA certification and operational safety requirements for certain airports.  
**Why it matters:** Part 139 airports typically have more formal processes for safety, construction coordination, and airfield operations.

Links:
- Part 139 overview (FAA): https://www.faa.gov/airports/airport_safety/part139_cert
- “What is Part 139?” (FAA): https://www.faa.gov/airports/airport_safety/part139_cert/what-is-part-139
- Part 139 (Cornell Law): https://www.law.cornell.edu/cfr/text/14/part-139
...
**Why it matters:** Use certified equipment, install it as intended, and don’t create interference issues for others.

Links:
- 47 CFR Part 15 (eCFR): https://www.ecfr.gov/current/title-47/chapter-I/subchapter-A/part-15
- 47 CFR Part 15 (Cornell Law): https://www.law.cornell.edu/cfr/text/47/part-15

---

## State & local considerations (example: Oregon)
Many states have their own aviation review/notification workflows that run alongside FAA processes.

Example (Oregon):
- Oregon Department of Aviation “Airspace and Tall Structures”: https://www.oregon.gov/aviation/doing-business-with-odav/pages/tall-structures.aspx

**Plain language summary:**  
- State agencies often want the same airspace notice info, and they can help guide sponsors through the process.

---

## Recommended “compliance-friendly” workflow for AviationWX installs
1. **Start with the Permission Packet** (Guide 01). Include who maintains the equipment and the removal plan.  
2. **Site survey** (Guide 02): choose candidate locations; capture photos; note approximate heights.  
3. **Ask the airport sponsor/manager:**  
   - “Is this considered a new structure or height change?”  
   - “Do you want/need a Part 77 (7460-1) filing?”  
...
## Where AviationWX keeps this simple
AviationWX tries to be a **good citizen**:
