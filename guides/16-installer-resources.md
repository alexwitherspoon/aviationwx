...
Mount two Duo 3 units on opposite sides of the pole when you need two approach views. One 3D-printed clamp and one PoE cable per camera.

### Wiring

Pole OD (1", 1.25", 1.31", 2") only changes which clamp you print; wiring is the same.
...
| 2 | 3D-printed Duo 3 pole mount | Match pole OD | [STL](/public/guides/installer-resources/stl/pole-mount-reolink-duo-3.stl) |
| 2 | Stainless worm band clamp | One per mount | Local |
...
One STL includes four clamp sizes. Print the body that matches your pole OD, once per camera.
...
- [pole-mount-reolink-duo-3.stl](/public/guides/installer-resources/stl/pole-mount-reolink-duo-3.stl) (~580 KB, all sizes)
- [TinkerCAD](https://www.tinkercad.com/things/0Hqfp1RWudF-pole-mount-reolink-duo-3?sharecode=OOd-vosqik8LMmsCVFXHJEy74SCSeqBrpWg8Lp-3Wps)

Secure each mount with a stainless worm band clamp. Aim lenses before final tightening.
...
Use 304 or 316 stainless outdoors. Do not use zip ties on the pole instead of the worm band.
...
Same pole layout idea as Path A: Tempest on top, two 180° cameras on the strut, enclosure on the pole. The [Duo 3 pole-mount STL](/public/guides/installer-resources/stl/pole-mount-reolink-duo-3.stl) fits many Reolink Wi-Fi housings; verify fit before printing.
...
| 3 | 3D-printed power brick holder | Adapters + hub brick; same STL | [STL](/public/guides/installer-resources/stl/power-brick-holder-bracket.stl) · [TinkerCAD](https://www.tinkercad.com/things/lUeq2FKBTpQ-power-brick-holder-bracket?sharecode=3Uei1E7HqngmkSWHAlFnIBShqNpHcL3AQ5ZuA-ayi6A) |
| 2 | 3D-printed Reolink pole mount | If Duo 3 clamp fits camera body | [STL](/public/guides/installer-resources/stl/pole-mount-reolink-duo-3.stl) |
| 2 | Stainless worm band clamp | One per camera | Local |
...
- Seat each OEM AC/DC adapter in a [brick holder](/public/guides/installer-resources/stl/power-brick-holder-bracket.stl); dress DC leads to the pole.
...
| Part | Use | Link |
|------|-----|------|
| Reolink Duo 3 pole clamp | 1", 1.25", 1.31", 2" in one STL | [STL](/public/guides/installer-resources/stl/pole-mount-reolink-duo-3.stl) · [TinkerCAD](https://www.tinkercad.com/things/0Hqfp1RWudF-pole-mount-reolink-duo-3?sharecode=OOd-vosqik8LMmsCVFXHJEy74SCSeqBrpWg8Lp-3Wps) |
| Power brick holder | AC/DC adapters in NEMA box | [STL](/public/guides/installer-resources/stl/power-brick-holder-bracket.stl) · [TinkerCAD](https://www.tinkercad.com/things/lUeq2FKBTpQ-power-brick-holder-bracket?sharecode=3Uei1E7HqngmkSWHAlFnIBShqNpHcL3AQ5ZuA-ayi6A) |
